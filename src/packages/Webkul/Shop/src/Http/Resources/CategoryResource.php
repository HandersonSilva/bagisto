    ...
    public function toArray($request)
    {
        return [
            ...
            'logo'         => $this->when($this->logo_path, [
                'small_image_url'    => config('filesystems.disks.r2.public_url').'/'.$this->logo_path,
                'medium_image_url'   => config('filesystems.disks.r2.public_url').'/'.$this->logo_path,
                'large_image_url'    => config('filesystems.disks.r2.public_url').'/'.$this->logo_path,
                'original_image_url' => config('filesystems.disks.r2.public_url').'/'.$this->logo_path,
