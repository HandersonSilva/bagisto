...
<footer class="mt-9 bg-[#2848b3] max-sm:mt-10">
                    ...
                    >
                        <div class="relative w-full">
                            <x-shop::form.control-group.control
                                type="email"
                                class="block w-[420px] max-w-full rounded-xl border-2 border-[#e9decc] bg-[#132d85] px-5 py-4 text-base max-1060:w-full max-md:p-3.5 max-sm:mb-0 max-sm:rounded-lg max-sm:border-2 max-sm:p-2 max-sm:text-sm"
                                name="email"
    ...
    <div class="flex justify-between bg-[#132d85] px-[60px] py-3.5 max-md:justify-center max-sm:px-5">
